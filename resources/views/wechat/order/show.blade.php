  ...
  <div class="order-detail" id="app" v-cloak>
    ...
    <div class="order-address">
      ...
      <div class="address-detail">
        <p>
          <span>收货人：{{ $order->address->contact_name }}</span>
          <span class="tel">{{ $order->address->contact_tel }}</span>
        </p>
    ...
    <div class="contracts">
      <div class="contract">
        ...
        <div class="btn-click right">
          ...
          <a onclick="downloadContract()">下载合同 </a>
          @else
          <a href="{{ route("wechat.company.create") }}">下载合同</a>
          @endif
        </div>
      </div>
    </div>
      ...
      <div class="express-box" v-if="express_box" v-cloak>
          ...
          <div class="e-info">
            ...
            <p class="green">
              ...
              <a href="tel:{{ auth()->user()->admin->mobile }}"></a>
              {{ auth()->user()->admin->mobile }}
            </p>
            @endif
          </div>
      	</div>
