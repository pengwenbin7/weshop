...
<html lang="zh-CN">
  <head>
    ...
    .pay .item .share-tip span{display: inline-block; display: none;background-color: #ff4f53;box-sizing: border-box;padding: .07rem .3rem;color: #fff;font-size: .26rem;}
          ...
          <div class="pay-limit">
            ...
            <p class = "share-tip">
              @if ($order->payment->share_discount <= 0)
        	       <span @click="share=true">分享至朋友圈立减{{ $order->payment->pay < 20000 ? 50 : 200  }}元</span>
              @else
