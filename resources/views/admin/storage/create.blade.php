...
<div class="col-md-12">
  <div class="box box-info">
    ...
    <form class="form-horizontal" action="{{ route("admin.storage.store") }}" method="POST" onsubmit="return app.check()">
      <div class="box-body">
        {{ csrf_field() }}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <textarea class="form-control" id="func" name="func" readonly>
              @{{  JSON.stringify(fee) }}
	      </textarea>
