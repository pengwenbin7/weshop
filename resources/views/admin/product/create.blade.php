  ...
  <div class="col-md-6">
	...
	<div class="box-body">
	  ...
	  <div class="form-group">
		...
		<input class="form-control" name="content" type="number" value="25" required>
	      </div>
	      <div class="form-group col-sm-4">
		<input class="form-control" name="measure_unit" type="text" value="kg" required>
	      </div>
	      <div class="form-group col-sm-4">
		<input class="form-control" name="packing_unit" type="text" value="包" required>
	      </div>
            </div>
	  </div>
